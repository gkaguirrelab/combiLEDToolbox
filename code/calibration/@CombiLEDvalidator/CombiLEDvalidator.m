...
% 4/28/2025  gka   Modified to perform validations
%

classdef CombiLEDvalidator < Calibrator
    ...
    methods
        % Constructor
        function obj = CombiLEDvalidator(initParams, modResult)
