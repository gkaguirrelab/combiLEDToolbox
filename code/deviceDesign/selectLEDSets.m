...
%{
    ...
    resultSetOurs = selectLEDSets('ledSPDFileName',ledSPDFileName,...
    ...
    filterCenterWavelengthsBest = [423 453 506 575 610 649 685];
    resultSetTheirs = selectLEDSets('ledSPDFileName',ledSPDFileName,...
        'ledTotalPowerFileName',ledTotalPowerFileName,...
        'filterCenterWavelengthsBest',filterCenterWavelengthsBest,...
        'primariesToKeepBest',primariesToKeepBest,'nTests',nTests,...
        'makePlots',false);
...
%{
    ...
    primariesToKeepBest = 1:8; nTests = 1;
    resultSet = selectLEDSets('ledSPDFileName',ledSPDFileName,...
        'adjustPrimaryPower',false,...
        'filterAdjacentPrimariesFlag',false,...
        'primariesToKeepBest',primariesToKeepBest,'nTests',nTests,...
        'makePlots',true);
