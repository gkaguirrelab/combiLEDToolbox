function flickerNull_LminusM_wide(subjectID,varargin)
...
% Create two modulations: The L direction and the M direction
    ...
    modResultL = designModulation('L_wide',...
        ...
        'primaryHeadroom',0);
    modResultM = designModulation('M_wide',...
        'observerAgeInYears',p.Results.observerAgeInYears,...
        'fieldSizeDegrees',p.Results.fieldSizeDegrees,...
        'pupilDiameterMm',p.Results.pupilDiameterMm, ...
        'primaryHeadroom',0);
...
if isfile(filename)
    ...
    stimFreqHz = measurementRecord.stimulusProperties.stimFreqHz;
else
