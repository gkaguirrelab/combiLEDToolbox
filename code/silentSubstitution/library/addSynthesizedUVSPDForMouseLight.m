function cal = addSynthesizedUVSPDForMouseLight(cal,includeDiffuserFlag)
...
% If the includeDiffuserFlag is not specified, set to false
if nargin == 1
...
% Put the modified variables back into the cal and return
cal.rawData.S = newS;
cal.processedData.P_device = newB_primary;
cal.processedData.P_ambient = newAmbientSPD;
